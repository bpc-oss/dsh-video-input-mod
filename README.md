...
**2026-09-12 P34/P35（毒视频熔断 + 2s 时长地板）**：zcode QA 会话被 1.66s 毒丸砖化（0 成功/22 失败）驱动新增；设计见 docs/DESIGN-P34-P35.md，功能验证 keep1/swap/survive + mvhd 4.00s/1.66s 全过，out3 重打包 294/294 集校验通过，部署 watcher 已挂（pre-p34 备份），重启后 zcode 会话自愈（首撞 400 → 熔断降级 → 次新顶上）。
## 仓库结构
